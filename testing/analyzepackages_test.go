...
func testExpectedOutput(t *testing.T, output []byte) {
	...
	expectedPaths := []expectedPath{
		...
		{Fn: []string{"transitive.InterestingOnceDo2$"}, Cap: "CAPABILITY_READ_SYSTEM_STATE"},
		{Fn: []string{"transitive.InterestingOnceDo3$"}, Cap: "CAPABILITY_READ_SYSTEM_STATE"},
		...
		{Fn: []string{"usereflect.CopyValueContainingStructAlias2$"}, Cap: "CAPABILITY_REFLECT"},
		{Fn: []string{"usereflect.CopyValueContainingStructAliasViaPointer"}, Cap: "CAPABILITY_REFLECT"},
